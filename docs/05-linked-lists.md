...
**ব্রেকডাউন**
- `Node` = data + next।
- `a.next = b` অর্থাৎ a থেকে b-তে তীর টানা।
...
**Complexity:** খুঁজে বের করা O(n), pointer বদল O(1)।
...
**Complexity:** append ও prepend O(1); search O(n)।
...
**Complexity:** append O(n), traversal O(n)।
...
Linked list অর্থাৎ data+next node-এর শৃঙ্খল; prepend O(1), access O(n)। Doubly অর্থাৎ দুমুখী, tail দিয়ে O(1) append। Circular অর্থাৎ শেষ থেকে head-এ বৃত্ত। কাঠামো বাছাই নির্ভর করে access বনাম insert প্যাটার্নের উপর।
