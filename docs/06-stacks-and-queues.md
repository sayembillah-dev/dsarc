...
**Complexity:** enqueue/dequeue O(1) (এই version-এ)।
...
**Complexity:** array version: back O(1), front O(n); linked-list version: সব O(1)।
...
**Complexity:** এই version: enqueue O(n log n); heap version: O(log n)।
...
Stack অর্থাৎ LIFO (push/pop, O(1)), undo/DFS-এ কাজে লাগে। Queue অর্থাৎ FIFO (enqueue/dequeue, দক্ষ version-এ O(1)), scheduling/BFS-এ লাগে। Deque অর্থাৎ দুই মুখের queue। Priority Queue-তে অগ্রাধিকার আগে বের হয় (heap দিয়ে দক্ষ)।
