...
**Complexity:** প্রযোজ্য নয় (এটা শুধু ভাষা পরিচিতি)।
...
**Complexity:** variable-এ মান রাখা/পড়া O(1)।
...
> সবসময় `===` ব্যবহার করবে, `==` নয়। `===` টাইপসহ মিলিয়ে দেখে (strict), তাই ভুল কম হয়।
...
**Complexity:** O(1) (শর্ত সংখ্যা নির্দিষ্ট হলে)।
...
**Complexity:** `n` বার চললে O(n)। loop-এর ভেতর loop হলে O(n²)।
...
**Complexity:** function-এর ভেতরের কাজের উপর নির্ভর করে।
...
**Complexity:** index access O(1); `map/filter/reduce` O(n)।
