...
**💡 ধারণা**
Heap একটা **complete binary tree** (উপর থেকে বাঁ→ডান পূর্ণ) যা একটা নিয়ম মানে:

- **Min-Heap:** প্রতিটা parent তার সন্তানদের চেয়ে **ছোট/সমান** → সবচেয়ে ছোট মান root-এ।
- **Max-Heap:** প্রতিটা parent তার সন্তানদের চেয়ে **বড়/সমান** → সবচেয়ে বড় মান root-এ।
...
- index `i`-এর **বাঁ সন্তান:** `2i + 1`
- index `i`-এর **ডান সন্তান:** `2i + 2`
...
const i = 1;                       // মান 3
console.log(heap[2 * i + 1]);      // বাঁ সন্তান → 5
console.log(heap[2 * i + 2]);      // ডান সন্তান → 9
...
> - **দৃশ্য:** উপরে tree, নিচে array; একটা index hover করলে দুই জায়গাতেই highlight + সন্তান/parent সূত্র দেখানো।
> - **ইনপুট:** index নির্বাচন।
> - **ধাপ:** সূত্র প্রয়োগ করে সন্তান/parent সেল চিহ্নিত হয়।
> - **লক্ষ্য:** array-heap দ্বৈততা।

**📝 অনুশীলন**
- index 3-এর parent ও সন্তান সূত্র দিয়ে বের করো।
...
**🔍 ব্রেকডাউন**
- শেষে যোগ → নিয়ম ভাঙতে পারে → parent-এর সাথে তুলনা করে উপরে তোলা।
...
> - **লক্ষ্য:** insert = "শেষে বসাও, তারপর উপরে ভাসো"।
...
> - **লক্ষ্য:** extract = "root নাও, শেষটা তোলো, নিচে ডুবাও"।
...
> - **ইনপুট:** মান; heap type।
> - **ধাপ:** push→bubble up, pop→bubble down; প্রতিটা swap গোনা হয়।
...
**ক্লাসিক প্রয়োগ:**
- **Top-K:** সবচেয়ে বড়/ছোট K উপাদান (min-heap of size K → O(n log K))
...
function topK(nums, k) {
  ...
  return heap.data.sort((a, b) => b - a); // বড় → ছোট
}
