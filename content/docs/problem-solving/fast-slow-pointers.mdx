...
দুটো pointer - একটা এক ধাপে (slow), একটা দুই ধাপে (fast)। cycle থাকলে fast একসময় slow-কে ধরে ফেলে (দুজন একই node-এ মেলে)। [Linked List](../linked-lists)-এ cycle detection, মাঝের node খোঁজা, ইত্যাদিতে ক্লাসিক। Floyd's cycle detection নামেও পরিচিত।
