...
ধরো, লক্ষ লক্ষ সংখ্যা থেকে শুধু ৩য় বৃহত্তমটা চাই। পুরো array-টা sort করা মানে কতটা অকাজের কাজ, ভাবো তো! **Quickselect** ঠিক এখানেই বুদ্ধি খাটায়। [Quick Sort](../sorting/quick-sort.mdx)-এর partition-ই ব্যবহার করে: একটা pivot তার ঠিক ঘরে বসে গেলেই দেখা যায় উত্তর কোন ভাগে পড়বে। অন্য ভাগটা ফেলে দাও; পুরো sort নয়, শুধু এক ভাগে খোঁজ চলে। আরেকটা পথ আছে: k-আকারের একটা **heap** রেখে সবাইকে একবার ঢুকিয়ে দিলেই top-k হাতে (stream-এ এটাই ভালো, দেখো [Heaps](../heaps/index.mdx) chapter)।
...
- গড়ে O(n), worst case O(n²) (খারাপ pivot পড়লে); heap-পথে O(n log k)।
