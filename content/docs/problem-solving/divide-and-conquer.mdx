...
তিন ধাপ: (১) **Divide** - সমস্যাকে ছোট উপ-সমস্যায় ভাগ, (২) **Conquer** - উপ-সমস্যা recursively সমাধান, (৩) **Combine** - ফলাফল জোড়া। [Merge Sort](../sorting/merge-sort.mdx), [Binary Search](../searching/binary-search.mdx) এর উদাহরণ।
