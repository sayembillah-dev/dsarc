...
sorted array বা string-এ দুটো pointer (সাধারণত দুই প্রান্ত থেকে, বা একই দিকে) একসাথে সরিয়ে অনেক nested-loop সমস্যা এক pass-এ সমাধান। "জোড়া খোঁজা", palindrome, sorted-এ pair-sum - সব এতে। array sorted না থাকলে আগে [Sorting](../sorting) chapter-এর কোনো sort চালাও।
