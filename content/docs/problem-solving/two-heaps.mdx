...
সংখ্যা একটা একটা আসতে থাকে (stream), আর যেকোনো মুহূর্তে median জানতে চাই। কৌশল: ছোট অর্ধেক রাখি **max-heap**-এ (শীর্ষে সেই অর্ধেকের সবচেয়ে বড়), বড় অর্ধেক **min-heap**-এ (শীর্ষে সেই অর্ধেকের সবচেয়ে ছোট)। দুটোর size-এর পার্থক্য সর্বোচ্চ ১ রাখলে median সবসময় heap-দুটোর শীর্ষে - O(1)। heap-এর ভিত্তি [Heaps](../heaps) chapter-এ।
