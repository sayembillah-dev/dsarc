...
ধরো, সংখ্যা একটা একটা আসতেই আছে (stream), আর যেকোনো মুহূর্তে জিজ্ঞেস করা যায়: বলো তো, এখন median কত? প্রতিবার sort করে তো আর চলা যায় না। এখানেই আসল জিনিস: ছোট অর্ধেকটা রাখো একটা **max-heap**-এ (শীর্ষে থাকবে ওই অর্ধেকের সবচেয়ে বড়টা), আর বড় অর্ধেক একটা **min-heap**-এ (শীর্ষে ওই অর্ধেকের সবচেয়ে ছোটটা)। দুটোর size-এর পার্থক্য সর্বোচ্চ ১ রাখলে median সবসময় heap-দুটোর শীর্ষে, O(1)-এ পেয়ে যাবে। heap-এর ভিত্তি [Heaps](../heaps/index.mdx) chapter-এ দেখেছো।
