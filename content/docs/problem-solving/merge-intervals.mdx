...
বেশ কিছু interval (যেমন মিটিংয়ের সময়সীমা) দেওয়া আছে; যেগুলো overlap করে সেগুলো জোড়া লাগিয়ে একটা করে বড় interval বানাতে হয়। চাবি: **শুরু অনুযায়ী sort** - তারপর বাঁ থেকে ডানে এক pass-এ শুধু শেষ merged interval-এর সাথে তুলনা করলেই চলে। মিটিং রুম, ক্যালেন্ডার merge, রেঞ্জ-কভারেজ সমস্যায় সরাসরি লাগে। sort-এর কৌশলগুলো [Sorting](../sorting/index.mdx) chapter-এ।
