...
ধরো, ট্রেনের জানালা দিয়ে বাইরে দেখছো। জানালা একটু সরলে পেছনের দৃশ্য আড়াল হয়, সামনে নতুন দৃশ্য ঢুকে; কিন্তু পুরো জগতটা কি প্রতিবার নতুন করে দেখতে হয়? না। এইটাই **sliding window**। একটা "জানালা" (window) array-এর উপর দিয়ে সরে, আর প্রতিবার পুরো window আবার হিসাব না করে শুধু **যোগ-বিয়োগ** করে আপডেট করো। ফল? O(n)। "k-আকারের সর্বোচ্চ যোগফল" বা "সবচেয়ে বড় distinct substring" জাতীয় সমস্যায় এটাই জাদু।
