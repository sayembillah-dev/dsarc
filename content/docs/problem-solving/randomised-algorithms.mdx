...
এলোমেলো পছন্দ ব্যবহার করে এমন algorithm, যার গতি/ফল খারাপ-ইচ্ছুক ইনপুটের (adversarial) হাতে ধরা পড়ে না। দুই ধরনের: **Las Vegas** - ফল সবসময় সঠিক, সময় এলোমেলো (random-pivot [Quick Sort](../sorting/quick-sort.mdx)); **Monte Carlo** - সময় নিশ্চিত, ফলে ছোট ভুল-সম্ভাবনা। quick sort-এ random pivot নিলে worst case O(n²) প্রায় অসম্ভব হয়ে যায় - তাই quicksort/[quickselect](./kth-element.mdx)-এ এটা প্রায় বাধ্যতামূলক অভ্যাস।
