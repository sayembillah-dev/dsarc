---
title: Common Runtimes (সব গুরুত্বপূর্ণ Complexity)
description: O(1) থেকে O(n!) পর্যন্ত সবচেয়ে দরকারি runtime-গুলো, ভালো থেকে খারাপ ক্রমে, বাস্তব উদাহরণসহ।
---
...
n = 20 হলে O(n²) = 400 অপারেশন (তুচ্ছ), কিন্তু O(2ⁿ) ≈ ১০ লাখ, আর O(n!) ≈ ২৪ কোটি কোটি! তাই বড় input-এ exponential/factorial প্রায় অচল।
</Callout>
