...
description: Array আর Object-এর মূল অপারেশন, DSA-র আসল building block।
---
...
ধরো, ক্যান্টিনে এক সারিতে লোক দাঁড়িয়ে আছে। প্রথম জন ০ নম্বর, পরের জন ১ নম্বর। নম্বর বললেই সেই লোকটাকে পেয়ে যাও। এটাই **array**। আবার ফোনের contact list-এ নাম লিখলেই নম্বর বেরিয়ে আসে, মানে key দিয়ে মান খোঁজা। সেটা **object**।
...
- `unshift/shift`: শুরুতে যোগ/বাদ (O(n), কারণ সবাইকে এক ঘর সরাতে হয়)।
- `map`: প্রতিটা মান রূপান্তর করে নতুন array বানায়।
- `filter`: শর্ত মেলে এমন মান নিয়ে নতুন array বানায়।
